...
public abstract class ConfigurationManager {
    ...
    public String denyBlockBreaks;
    public String useDynamite;
    public String denyPlaceBlock;
    public String denyPlaceFire;
    public String denyPlaceFrostedIce;
    public String denyUseBlock;
    public String denyOpenInventory;
    public String denyTakeItem;
    public String denyUseAnvil;
    public String denySleepInBed;
    public String denyUseRespawnAnchor;
    ...
    public String denyUseLingeringPotion;
    public String denyPlaceObject;
    public String denyHitEntity;
    public String denyChangeItemFrame;
    public String denyOpenChest;
    public String denyRideEntity;
    public String denyPvP;
    public String denyDamageAnimal;
    public String denyInteractEntity;
    public String denyRideVehicle;
    public String denyChangeEntity;
    public String denyBreakVehicle;
    public String denyPickUpItem;
    public String denyDamagePlayer;
    public String denyDamageHostileMob;
    public String denyDamageAmbientMob;
    public String denyChangePainting;
    public String denyInteractWithNPC;
    public String denyRideHostileMob;
    public String denyRideAmbientMob;
    public String denyDamageNonHostile;
    public String denyInteractWithItemFrame;
    public String denyUsePotion;
    public String denyInteractWithVehicle;
    public String denyPlaceTnt;
    public String denyPlaceBed;
    public String denyUseBlockWithChestAccess;
    public String denyPlaceItem;
    public String denyInteractWithAnvil;
    public String denyInteractWithChest;
    public String denyCreatePortal;
    public String denyUseCommand;
    public String denyChatMessage;
    public String addMemberMessage;
    public String addOwnerMessage;
    public String removeMemberMessage;
    public String removeOwnerMessage;
    public String defineRegionMessage;
    public String redefineRegionMessage;
    public String claimRegionMessage;
    public String selectRegionMessage;
    public String removeRegionSuccessMessage;
